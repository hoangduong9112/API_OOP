...
public class TestGetSlider extends TestBase {
    private TestGetSlider(ItemParams itemParams, String testDescription, String codeExpectation, String messageExpectation) throws
        ...
        if (itemParams.token) {
            ...
            result = getMethod(APIPath.GET_SLIDER, null, itemParams.accessToken);
        } else {
            System.out.println("Don't have token ");
            result = getMethod(APIPath.GET_SLIDER, null, null);
        }
        Gson g = new Gson();

        Type response = new TypeToken<Response<SliderDataType[]>>() {
        }.getType();
        Response<SliderDataType[]> rp = g.fromJson(result, response);
    ...
    public static void main() throws
        ...
        ItemParams params3 = new ItemParams(false);
...
//
    ...
    protected static class SliderDataType {
