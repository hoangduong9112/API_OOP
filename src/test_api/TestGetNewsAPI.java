...
public class TestGetNewsAPI extends TestBase {
    ...
    public static void main() throws IOException {
        ...
        for (TestCase<GetNewsParams> testCase : listTestCase) {
            new TestGetNewsAPI(testCase.params(), testCase.testDescription(), testCase.codeExpectation(), testCase.messageExpectation());
        }
    }
